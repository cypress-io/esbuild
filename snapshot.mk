...
snap-publish-all: cmd/esbuild/version.go snap-test-prepublish
	@test ryanm/fix/snapshot-improvements = "`git rev-parse --abbrev-ref HEAD`" || (echo "Refusing to publish from non-snapshot branch `git rev-parse --abbrev-ref HEAD`" && false)
